...
const Search = ({ onFilterChange }) => {
  ...
  // Memoize hàm `debounce` để tránh tạo lại hàm mới mỗi khi component re-render
  ...
  const handleChange = (e) => {
    ...
    setSearchTerm(value);
    handleSearch(value); // Gọi hàm debounce đã được memoize
  };
    ...
    <>
      <div className="flex w-full items-center">
        <div className="flex-grow mr-2">
          <div className="flex px-4 py-3 rounded-md border-2 border-blue-500 overflow-hidden font-[sans-serif]">
            ...
            <input
              ...
              placeholder="Tìm kiếm: Tên, Nội dung chuyển khoản"
        ...
        <div className="flex justify-center items-center">
          <ModalButton onFilter={onFilterChange} />
        </div>
      </div>
    </>
  );
